...
class Database {
   ...
   * @returns {Collection}
   */
  createCollection(name, Collection=BaseCollection, defaultValues={}) {
  ...
  #addOrSubtract(operation, key, value) {
    ...
    else if (['undefined', 'number'].every(t => typeof existentData !== t)) throw new TypeError('The value of the provided key must be a number');
