...
class Collection {
  ...
  save() {
    ...
    try {
      ...
      if (e.code === 'EACCES') throw new Error('The file of the collection could not be accessed');
    }
  }
  ...
  #fetchData() {
    ...
    try {
      ...
      else if (e.code === 'EACCES') throw new Error('The file of the collection could not be accessed');
    }
  }
}
